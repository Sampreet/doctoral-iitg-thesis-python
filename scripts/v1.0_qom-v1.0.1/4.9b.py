...
if __name__ == '__main__':
    # without voltage 
    params['looper']['file_path_prefix'] = 'data/v1.0_qom-v1.0.1/4.9b_A_vs=[50.0, 0.0, 0.0]'
    ...
    params['looper']['file_path_prefix'] = 'data/v1.0_qom-v1.0.1/4.9b_A_vs=[50.0, 50.0, 50.0]'
