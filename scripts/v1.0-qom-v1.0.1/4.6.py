...
if __name__ == '__main__':
    # low kappa
    params['looper']['file_path_prefix'] = 'data/v1.0-qom-v1.0.1/4.6_var_kappa=0.1'
    ...
    # high kappa
    params['looper']['file_path_prefix'] = 'data/v1.0-qom-v1.0.1/4.6_var_kappa=1.0'
    ...
    # low kappa
    params['looper']['file_path_prefix'] = 'data/v1.0-qom-v1.0.1/4.6_entan_kappa=0.1'
    params['system']['kappa_norm'] = 0.1
    looper  = run_loopers_in_parallel(
        looper_name='XYLooper',
    ...
    # high kappa
    params['looper']['file_path_prefix'] = 'data/v1.0-qom-v1.0.1/4.6_entan_kappa=1.0'
    params['system']['kappa_norm'] = 1.0
    looper  = run_loopers_in_parallel(
        looper_name='XYLooper',
        func=func_rat_entan_ln,
